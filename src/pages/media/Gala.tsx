...
export default function Gala() {
  ...
  return (
    <>
      <Helmet>
        <title>{`NESA-Africa ${year} Blue Garnet Awards Gala | Lagos · 13 Dec 2026`}</title>
        <meta
          name="description"
          content={`The NESA-Africa ${year} Blue Garnet Awards Gala — a cinematic continental celebration of Africa's education changemakers. Lagos · 13 Dec 2026.`}
        />
