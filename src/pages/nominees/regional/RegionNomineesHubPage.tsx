          ...
          >
            ...
            <div className="relative px-6 py-10 md:px-10 md:py-14 text-center flex flex-col items-center">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <Link to="/awards/gold-blue-garnet"><Button size="lg" className="bg-gold hover:bg-gold/90 text-charcoal font-bold rounded-full px-7 gap-2 shadow-lg shadow-gold/20"><Trophy className="w-4 h-4" /> Learn More</Button></Link>
