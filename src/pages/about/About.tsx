          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <h1 className="mb-6 font-display text-4xl font-bold text-white md:text-5xl lg:text-6xl">
                About <span className="text-primary">NESA-Africa</span>
              </h1>
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="text-lg leading-relaxed text-white/80">
                ...
                driving <strong className="text-primary">Education for All</strong> across Africa —
            ...
            <div className="mx-auto grid max-w-3xl gap-4 md:grid-cols-2">
              {quickLinks.map((link) => (
                <Link
                  key={link.href}
                  to={link.href}
                  className="group flex items-center justify-between rounded-lg border border-white/10 bg-white/5 p-4 transition-colors hover:border-primary/50 hover:bg-white/10"
                >
