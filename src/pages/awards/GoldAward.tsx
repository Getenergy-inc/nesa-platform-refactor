...
const features = [
  {
    icon: Vote,
    title: "100% Public Voting",
    description:
      "Winners determined entirely by public votes — no jury influence.",
  },
  {
    icon: Globe,
    title: "Region-First",
    description: "Regional winners qualify for continental competition.",
  },
  {
    icon: Users,
    title: "Top 3 Per Subcategory",
    description: "405 Gold Certificate winners across 135 subcategories.",
  },
  {
    icon: Trophy,
    title: "Feeds Blue Garnet",
    description: "All 405 Gold winners compete for the 9 Blue Garnet Awards.",
  },
];
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-charcoal">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <h3 className="font-display text-2xl md:text-3xl font-bold text-white mb-4">
                    Earn Voting Points.{" "}
                    <span className="text-amber-400">Decide Winners.</span>
                  </h3>
                  <p className="text-white/70 mb-6">
                    Your participation earns{" "}
                    <span className="text-gold font-semibold">
                      AGC voting credits
                    </span>
                    . Use them during the Gold Certificate voting window to
                    support your favorite nominees.
                  </p>
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto grid max-w-4xl gap-6 text-center md:grid-cols-4">
              {[
                ...
                <div
                  key={step.phase}
                  className={step.status === "active" ? "" : "opacity-60"}
                >
                  <div
                    className={`h-2 w-2 mx-auto rounded-full mb-2 ${step.status === "active" ? "bg-amber-400" : "bg-white/30"}`}
                  />
                  <div className="text-xs uppercase tracking-wider text-white/50">
                    {step.phase}
                  </div>
                  <div
                    className={`mt-1 font-semibold ${step.status === "active" ? "text-amber-400" : "text-white"}`}
                  >
                    {step.date}
                  </div>
                </div>
        ...
        <section className="bg-charcoal/95 py-16 lg:py-24">
          <div className="container mx-auto px-4">
            ...
            <p className="mx-auto mb-12 max-w-2xl text-center text-white/60">
              Winners are selected at regional level first, ensuring fair
              representation across the continent.
            </p>
              ...
              {[
                {
                  step: 1,
                  title: "Nomination",
                  desc: "Submit or receive nomination with evidence",
                  icon: Award,
                },
                {
                  step: 2,
                  title: "NRC Review",
                  desc: "Validation by Nominee Research Corps",
                  icon: Check,
                },
                {
                  step: 3,
                  title: "Public Voting",
                  desc: "Vote with AGC during official window",
                  icon: Vote,
                },
                {
                  step: 4,
                  title: "Gold Winner",
                  desc: "Top vote-getter wins Gold Certificate",
                  icon: Trophy,
                },
              ].map((s, index) => (
                <motion.div
        ...
        {/* TV Show Section */}
        {goldTVShow && (
          <AwardTVShowSection show={goldTVShow} accentColor="gold" />
        )}
        ...
        <section className="bg-gradient-to-b from-charcoal to-amber-900/20 py-16 lg:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="mx-auto mb-8 max-w-xl text-white/60">
              Nominate Africa's education champions or earn AGC to vote during
              the official window.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Button
                asChild
                size="lg"
                className="bg-amber-500 hover:bg-amber-600 text-charcoal font-semibold rounded-full gap-2"
              >
                <Link to="/nominate">
