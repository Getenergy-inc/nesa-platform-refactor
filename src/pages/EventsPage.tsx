...
const QUICK_LINKS = [
  {
    ...
    href: "/tickets",
    description: "Reserve seats for the 22 October 2026 Recognition Gala.",
    icon: Ticket,
  },
  {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Consolidated calendar for NESA-Africa 2026 — TV shows, public activations, webinars, the Recognition Gala on 22 October 2026, and the EduAid-Africa launch."
        />
        ...
        <header className="border-b border-white/10 bg-gradient-to-b from-black/60 to-transparent">
          <div className="container py-12 md:py-16">
            ...
            <p className="mt-4 max-w-2xl text-white/70">
              ...
              Garnet Recognition Gala on 22 October 2026 in Lagos.
            </p>
          </div>
        </header>
