...
export default function NomineeDirectory() {
  ...
  return (
    <>
      <Helmet>
        <title>NESA-Africa 2026 Nominee Directory | Education Impact</title>
        <meta name="description" content="Explore NESA Africa 2026 Award nominees across 14 categories, 15 regions (8 Africa + 7 Global), and 3 subcategories. Discover and support education champions across Africa." />
      </Helmet>
