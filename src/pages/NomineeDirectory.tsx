  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Explore NESA Africa 2026 Award nominees across 14 categories, 15 regions (8 Africa + 7 Global), and 3 subcategories. Vote and support education champions across Africa." />
      </Helmet>
