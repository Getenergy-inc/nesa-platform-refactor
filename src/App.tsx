...
import EduAidJournal from "./pages/journal/EduAidJournal";
            ...
            <RegionProvider>
              <BrowserRouter>
                ...
                <Routes>
                  ...
                  <Route path="/about/timeline" element={<Navigate to="/timeline" replace />} />
                  <Route
                    path="/timeline"
                    element={
                      <WithLayout>
                  ...
                  />
                  <Route path="/impact/reports" element={<Navigate to="/journal" replace />} />
                  <Route
                    path="/impact/stories"
                    element={
                      <WithLayout>
