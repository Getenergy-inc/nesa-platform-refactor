  ...
  if (variant === "compact") {
    return (
      <p className="text-[11px] leading-snug text-white/55 flex items-start gap-1.5">
        ...
        Sponsorship, donation, ticket, merch, endorsement, media visibility, or AGC Voting Coin
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-white/70 leading-relaxed">
            ...
            visibility, or AGC Voting Coin participation does not influence nomination approval,
