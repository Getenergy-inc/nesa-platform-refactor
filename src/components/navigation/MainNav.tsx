  ...
  return (
    <Sheet open={open} onOpenChange={handleOpenChange}>
      ...
      <SheetContent
        ...
        side="right"
        className="w-[min(100vw,420px)] sm:max-w-sm bg-charcoal border-l border-gold/20 p-0 overflow-hidden z-[100]"
      >
...
export function MainNav() {
  ...
  return (
    <>
      <header
        className="fixed top-0 left-0 right-0 z-[80] w-full bg-charcoal/95 backdrop-blur-md border-b border-gold/20 overflow-x-clip"
        ...
        <div className="container flex h-14 sm:h-16 items-center gap-2 px-3 sm:px-4 max-w-screen-2xl">
          ...
          >
            <img
              src={nesaStamp}
              alt="NESA-Africa"
              className="h-8 sm:h-10 w-8 sm:w-10 rounded-full object-contain shrink-0"
            />
            <div className="flex flex-col leading-tight min-w-0">
              <span className="text-[11px] sm:text-sm font-display font-bold text-gold tracking-wide whitespace-nowrap">
                NESA-Africa <span className="text-white/70 font-medium">2026</span>
              </span>
              <span className="hidden sm:block text-[9px] xl:text-[10px] text-gold/70 font-medium tracking-wider italic">
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0 ml-auto">
            ...
            >
              <Link to="/nominate" aria-label="Nominate for NESA-Africa 2026">
                ...
                <span className="inline">Nominate<span className="hidden xs:inline sm:inline"> 2026</span></span>
              </Link>
            </Button>
