  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-input bg-background hover:bg-accent hover:text-accent-foreground hover:scale-105 active:scale-95",
        ...
        // Fun Gen-Z variants
        glow: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-[0_0_30px_rgba(201,162,39,0.5)] hover:scale-105 active:scale-95 transition-all duration-300",
        rainbow: "bg-gradient-to-r from-primary via-purple-500 to-cyan-500 text-white font-bold hover:scale-105 active:scale-95 animate-gradient-shift",
