    ...
    <section id="watch" className="bg-charcoal py-16 md:py-20">
      <div className="container">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="aspect-video bg-charcoal-light rounded-2xl border border-gold/20 flex items-center justify-center mb-6">
            <div className="text-center">
              ...
              <p className="text-white/70">NESA-Africa Video</p>
            </div>
          </div>

          <div className="flex justify-center">
            <Button variant="outline" className="border-gold text-gold hover:bg-gold/10 rounded-full gap-2">
