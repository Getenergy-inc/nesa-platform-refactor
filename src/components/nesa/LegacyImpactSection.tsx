      ...
      <div className="container relative z-10 max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-white/80 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-4">
            Every nomination, vote, and donation upgrades inclusive education
            facilities for special needs students across Africa's regions.
          </p>

          <p className="text-white/50 text-base italic mb-12">
