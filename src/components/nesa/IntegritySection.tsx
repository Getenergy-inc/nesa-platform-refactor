        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
          {firewalls.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white/3 rounded-xl p-5 border border-white/8 hover:border-gold/20 transition-colors group"
            >
              <div className="h-10 w-10 rounded-lg bg-white/5 flex items-center justify-center mb-4 group-hover:bg-gold/10 transition-colors">
                <item.icon className={`h-5 w-5 ${item.iconColor} group-hover:text-gold transition-colors`} />
              </div>
