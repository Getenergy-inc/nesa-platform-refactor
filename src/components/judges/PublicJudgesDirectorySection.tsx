  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-gold/80">The Jury</p>
      ...
      {loading ? (
        ...
        <div className="mt-8 rounded-xl border border-dashed border-gold/30 bg-white/[0.03] p-8 text-center">
          <Gavel className="mx-auto h-8 w-8 text-gold/80" aria-hidden />
          ...
          <div className="mt-5 flex flex-wrap justify-center gap-3">
            <Button asChild className="bg-gold text-arena-bg hover:bg-gold/90">
            ...
            >
              <div className="flex items-center gap-3">
                <Avatar className="h-12 w-12 border border-gold/30">
                  ...
                  <AvatarFallback className="bg-arena-panel text-gold">
                    {j.full_name.slice(0, 2).toUpperCase()}
                  </AvatarFallback>
                </Avatar>
                <div className="min-w-0">
                  <p className="truncate font-semibold group-hover:text-gold">{j.full_name}</p>
              ...
              <p className="mt-4 inline-flex items-center gap-1.5 text-xs font-semibold text-gold/85">
