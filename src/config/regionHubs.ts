...
export const REGION_HUBS: RegionHubConfig[] = [
  ...
  },
  {
    ...
    countries: ["North America (USA, Canada)", "United Kingdom & Ireland", "Europe (France, Germany, Netherlands, Belgium, Italy, Portugal, Switzerland, Scandinavia)", "Middle East (UAE, Saudi Arabia, Qatar)", "Asia-Pacific (Australia, New Zealand, China, India, Japan)", "South America (Brazil, Argentina)", "Caribbean diaspora communities"],
    culturalHighlights: ["Diaspora alumni networks & national unions (NIDO, GUBA, etc.)", "Afrobeats, Amapiano and African cinema as global cultural classrooms", "Diaspora-led STEM, EdTech and scholarship foundations", "Heritage and homecoming movements (Year of Return, Beyond the Return)"],
    eduTourismFacts: ["Diaspora remittances to Africa exceed US$95B annually — a growing share funds schools, scholarships and EdTech", "African scholars hold leadership roles in 200+ universities across North America and Europe", "Diaspora-founded EdTech ventures already serve millions of African learners across all 8 Africa Regions", "Homecoming and heritage tours connect diaspora youth to African schools, universities and innovation hubs"],
