...
export const AGC_EARNING_METHODS: AGCEarningMethod[] = [
  ...
  },
  {
    ...
    reward: '+15 AGC',
    rewardAgcc: 150, // 15 AGC = 150 AGCc
    icon: 'Users',
    isActive: true,
  },
  {
    ...
    reward: '+5 AGC',
    rewardAgcc: 50, // 5 AGC = 50 AGCc
    icon: 'UserPlus',
    isActive: true,
  },
  {
    id: 'nominee_verification',
    source: 'NOMINATION_VERIFIED',
    title: 'Nominee Verification Bonus',
    description: 'Earn AGCc when nominations include correct nominee email, phone number, and successful verification confirmation.',
    reward: 'AGCc on verification',
    rewardAgcc: 5,
    icon: 'CheckCircle',
    isActive: true,
...
export const AGC_QUICK_SUMMARY = [
  ...
  { label: 'Every nomination', value: '+5 AGCc' },
