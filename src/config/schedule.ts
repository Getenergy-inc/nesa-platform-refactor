...
// PUBLIC NOMINATIONS OPEN FOR ALL 4 TIERS: 6 September 2026
...
export function buildTimeline(
  ...
  return [
    ...
    },
    {
      ...
      description:
        "Public nominations for all four Recognition Tiers open on 6 September 2026. The Africa Education Icon window closes 12 September — celebrating transformational Education Enablers (2006–2026).",
      type: "recognition",
    },
    {
