    ...
    children: [
      {
        ...
        href: "/events",
        description: "Calendar of NESA-Africa events",
      },
      {
        label: "Get Tickets",
        href: "/tickets",
        description: "Reserve your seat at the Gala",
        icon: Ticket,
        stageGated: "tickets",
      },
      {
        ...
        href: "/events/tourism",
        description: "Experience Africa's educational heritage",
      },
    ],
  },
  {
    ...
    children: [
      {
        label: "Donate",
        href: "/donate",
        description: "Support education transformation in Africa",
        icon: Wallet,
      },
      {
        label: "EduAid-Africa",
