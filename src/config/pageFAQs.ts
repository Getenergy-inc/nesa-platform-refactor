...
//   Motto / Brand Line: "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers"
//
...
const DEFAULT_FAQS: FAQ[] = [
  {
    ...
    a: 'New Education Standard Award Africa (NESA-Africa) is a continental recognition and impact platform celebrating individuals, schools, organisations and partners advancing Education for All across Africa and the African diaspora. Its motto is "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers".',
  },
  {
...
export const PAGE_FAQS: PageFAQ[] = [
  // ---------------- 1. HOMEPAGE ----------------
  {
    ...
    subtitle:
      'New Education Standard Award Africa (NESA-Africa) 2026 — "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers". Quick answers for first-time visitors.',
    viewAllHref: "/faq",
    viewAllLabel: "Open Full FAQ Hub",
    faqs: [
      {
        q: "What is New Education Standard Award Africa (NESA-Africa)?",
        a: 'New Education Standard Award Africa (NESA-Africa) is a continental recognition and impact platform celebrating people, schools, organisations and partners advancing Education for All across Africa and the diaspora. Its motto is "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers".',
      ...
      {
        q: 'What is the motto "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers"?',
  ...
  // ---------------- 2. ABOUT ----------------
  {
    ...
    faqs: [
      ...
      {
        q: 'What does the motto "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers" mean?',
  ...
  // ---------------- 3. AWARDS ----------------
  {
    ...
    subtitle:
      'The recognition structure of New Education Standard Award Africa (NESA-Africa) 2026 — "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers".',
    viewAllHref: "/faq",
    faqs: [
      {
  ...
  // ---------------- 8. SPONSORSHIP ----------------
  {
    ...
    subtitle:
      'Sponsorship categories, benefits and integrity rules for "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers".',
    viewAllHref: "/faq",
    faqs: [
      {
  ...
  // ---------------- 15. BLUE GARNET AWARDS GALA ----------------
  {
    ...
    subtitle:
      'The continental finale of NESA-Africa 2026 — "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers".',
    viewAllHref: "/faq",
    faqs: [
      {
  ...
  // ---------------- Fallback ----------------
  {
    ...
    subtitle:
      'About New Education Standard Award Africa (NESA-Africa) 2026 — "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers".',
    faqs: DEFAULT_FAQS,
  },
];
...
export const FULL_FAQ_GROUPS: FAQGroup[] = [
  {
    ...
    description:
      'New Education Standard Award Africa (NESA-Africa) and the motto "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers".',
    faqs: [
      {
        q: "What is New Education Standard Award Africa (NESA-Africa)?",
      ...
      {
        q: 'What is "The African Blue-Garnet Awards for Recognising Africa’s Education Enablers"?',
