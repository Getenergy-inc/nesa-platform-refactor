  ...
  subcategories: [
    {
      ...
      blurb: "This is a once-in-a-decade honour. Nominate a philanthropist whose lifetime giving has transformed African education.",
      recognises: "Philanthropists with lifetime educational impact",
      scope: "Continental",
      subcategoryCount: 1,
      voteSplit: "Jury only",
    ...
    },
    {
      ...
      blurb: "Nominate a literary figure or curriculum reformer who has shaped how Africa's children learn.",
      recognises: "Literary figures advancing curriculum development",
      scope: "Continental",
      subcategoryCount: 1,
      voteSplit: "Jury only",
    ...
    },
    {
      ...
      blurb: "Nominate a pioneer of technical and vocational education whose work has opened doors for an entire generation.",
      recognises: "Technical and vocational education pioneers",
      scope: "Continental",
      subcategoryCount: 1,
      voteSplit: "Jury only",
