...
const ICON: TierClusterConfig = {
  ...
  nominees: {
    ...
    empty: "Icon nominations open 6 September 2026. Confirmed nominees will appear here as NRC verification completes.",
...
const BLUE_GARNET: TierClusterConfig = {
  ...
  criteria: {
    ...
    timelineNote:
      "Nominations open 6 September 2026, close 21 November 2026. Finalists announced after NRC verification. Winners revealed at the Gala on 13 December 2026.",
  },

  nominees: {
    directoryFilterKey: "gold-blue-garnet",
    directoryLabel: "Explore Blue-Garnet nominees",
    empty: "Blue-Garnet nominations open 6 September 2026 across nine competitive categories.",
...
const PLATINUM: TierClusterConfig = {
  ...
  criteria: {
    ...
    timelineNote:
      "Platinum institutional nominations open 6 September 2026 and close 21 November 2026. Recognised institutions are honoured at the Gala on 13 December 2026.",
  },

  nominees: {
    directoryFilterKey: "platinum-recognition",
    directoryLabel: "Explore Platinum nominees",
    empty: "Platinum institutional nominations open 6 September 2026 across seven categories.",
...
const INFLUENCER: TierClusterConfig = {
  ...
  criteria: {
    ...
    timelineNote:
      "Influencer nominations open 6 September 2026, close 21 November 2026. Recognised influencers appear on the NESA-Africa Recognition Gala broadcast on 13 December 2026.",
  },

  nominees: {
    directoryFilterKey: "influencer-education-impact",
    directoryLabel: "Explore Influencer nominees",
    empty: "Influencer nominations open 6 September 2026 across the three subcategories.",
