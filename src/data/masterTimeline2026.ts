...
export const MASTER_TIMELINE_2026: MasterTimelineEntry[] = [
  ...
  },
  {
    ...
    milestone: "EduAid-Africa Webinar 1 · Fame With Purpose",
    activity: "Mobilising influencers and public figures around scholarship support. Pilot episode — Influencer Education Impact.",
  ...
  },
  {
    ...
    activity: "Reforming what and how Africa's children learn.",
  ...
  },
  {
    ...
    activity: "Closing episode — global partners and Diaspora Africans investing in education.",
    outcome: "Icon only — content boundary applies",
    track: "webinar",
    href: "/media/webinars",
  },
