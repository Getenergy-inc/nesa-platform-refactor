...
export const RECOGNITION_JOURNEY_2026: JourneyPhase[] = [
  ...
  },
  {
    ...
    description:
      "Two distinct windows apply: Africa Education Icon closes early on 6 October 2026 so judges can complete their review, while Gold-Blue Garnet, Platinum Recognition and Influencer Education Impact stay open to 21 November 2026 — giving nominees time to request physical printed certificates before the Gala.",
  ...
  },
  {
    ...
    dateRange: "6 September – 6 October 2026",
    startsAt: "2026-09-06T00:00:00Z",
    ...
    description:
      "A one-month nomination window across three Icon subcategories and three origin groups. Selection is by the independent Icon judges only — there is no public vote.",
    categories: [
  ...
  },
  {
    ...
    dateRange: "23 September – 13 December 2026",
    ...
    description:
      "Verification runs continuously from 23 September through Gala day so Certificates of Recognition can be issued as nominations clear review — covering Gold-Blue Garnet, Platinum Recognition and Influencer Education Impact nominations as they arrive.",
  ...
  },
  {
    ...
    dateRange: "20 October – 24 November 2026",
    ...
    description:
      "Deliberation and scoring take place in the Judges Arena under full audit logging. All 9 Icon recipients are confirmed by 24 November 2026.",
  ...
  },
  {
    ...
    description:
      "Profiles, citations, scripts and rehearsals are finalised immediately after the 24 November Icon selection lock, ahead of the TV showcases and the Recognition Gala.",
    outcomes: ["Gala-ready programme, scripts and honouree citations"],
    ctas: [{ label: "See the Master Timeline", to: "/timeline" }],
  },
  {
    id: "tv-showcases",
    number: 11,
    name: "TV Showcases — Platinum, Influencer, Icon & Gold-Blue Garnet",
    shortName: "TV Showcases",
    dateRange: "22 November & 8 December 2026",
    startsAt: "2026-11-22T00:00:00Z",
    endsAt: "2026-12-08T23:59:59Z",
    status: "upcoming",
    tier: "Cross-Tier",
    iconName: "Tv",
    accent: "yellow",
    ...
    description:
      "TV Showcase 1 (22 November) presents Platinum Recognition and Influencer Education Impact Certificates of Recognition. TV Showcase 2 (8 December) presents the Africa Education Icon recipients alongside verified Gold-Blue Garnet Enablers.",
