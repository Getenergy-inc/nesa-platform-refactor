...
export const RECOGNITION_JOURNEY_2026: JourneyPhase[] = [
  ...
  },
  {
    ...
    dateRange: "16 September – 14 December 2026",
    startsAt: "2026-09-16T00:00:00Z",
  ...
  },
  {
    ...
    dateRange: "July – December 2026 (parallel operational track)",
    startsAt: "2026-07-01T00:00:00Z",
    endsAt: "2026-12-14T23:59:59Z",
    status: "current",
    tier: "Cross-Tier",
    ...
    activities: [
      ...
      "NESA-Africa Weekly News — every Friday (July – December 2026) covering the entire recognition campaign",
