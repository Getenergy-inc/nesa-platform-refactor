...
const pages: Record<string, DetailedAwardCategoryPage> = {
  ...
  "bg-edutech-africa": {
    ...
    primaryCta: { label: "Nominate an Education Enabler", href: nominateHref("gold-blue-garnet", "best-edutech-innovation-for-education-africa-regional") },
    secondaryCta: { label: "Meet Existing Nominees", href: exploreHref("Best EduTech Organisation (Africa Regional)") },
    overview: [
  ...
  "bg-ngo-nigeria": {
    ...
    primaryCta: { label: "Nominate an Education Enabler", href: nominateHref("gold-blue-garnet", "best-ngo-for-education-advancement-nigeria") },
    secondaryCta: { label: "Meet Existing Nominees", href: exploreHref("Best NGO Contribution to Education (Nigeria)") },
    overview: [
  ...
  "bg-ngo-africa": {
    ...
    primaryCta: { label: "Nominate an Education Enabler", href: nominateHref("gold-blue-garnet", "best-ngo-contribution-to-education") },
    secondaryCta: { label: "Meet Existing Nominees", href: exploreHref("Best NGO Contribution to Education (Africa Regional)") },
    overview: [
  ...
  "bg-stem-africa": {
    ...
    secondaryCta: { label: "Meet Existing Nominees", href: exploreHref("Best STEM Education Programme (Africa Regional)") },
    overview: [
