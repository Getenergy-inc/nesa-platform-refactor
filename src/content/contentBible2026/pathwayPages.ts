...
const pages: Record<string, DetailedAwardCategoryPage> = {
  ...
  "pt-international": {
    ...
    secondaryCta: { label: "Meet Existing Nominees", href: exploreHref("International Partners Supporting Education") },
    overview: [
  ...
  "pt-diaspora": {
    ...
    secondaryCta: { label: "Meet Existing Nominees", href: exploreHref("African Diaspora Organisations Supporting Education") },
    overview: [
