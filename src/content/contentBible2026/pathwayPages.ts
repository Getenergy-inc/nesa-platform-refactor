...
export const GALA_NOTE =
  "The NESA-Africa 2026 Gala and Awards Ceremony is scheduled for 22 October 2026 in Lagos, Nigeria. Attendance is optional and does not affect recognition.";
...
const pages: Record<string, DetailedAwardCategoryPage> = {
  ...
  "pt-international": {
    ...
    subcategories: [
      sub("embassies-high-commissions", "Embassies and High Commissions", "Diplomatic missions supporting education.", "Diplomatic", "Continental", "international-partners-supporting-education", "platinum-recognition", "International Partners Supporting Education"),
      sub("bilateral-aid-agencies", "Bilateral Aid Agencies", "Bilateral development agencies.", "Government agency", "Continental", "international-partners-supporting-education", "platinum-recognition", "International Partners Supporting Education"),
      sub("multilateral-ingos", "Multilateral and International NGOs", "Multilateral bodies and international NGOs.", "Multilateral", "Continental", "international-partners-supporting-education", "platinum-recognition", "International Partners Supporting Education"),
      sub("global-grant-foundations", "Global Education Grant Foundations", "Global education-grant foundations.", "Foundation", "Continental", "international-partners-supporting-education", "platinum-recognition", "International Partners Supporting Education"),
      sub("multinational-corporations", "Multinational Corporations", "MNCs with sustained African education programmes.", "Corporate", "Continental", "international-partners-supporting-education", "platinum-recognition", "International Partners Supporting Education"),
      sub("un-agencies", "UN Agencies", "United Nations agencies working on education.", "UN", "Continental", "international-partners-supporting-education", "platinum-recognition", "International Partners Supporting Education"),
      sub("international-ngos", "International NGOs", "International NGOs working across Africa.", "INGO", "Continental", "international-partners-supporting-education", "platinum-recognition", "International Partners Supporting Education"),
    ],
