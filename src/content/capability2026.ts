...
export const ABOUT_INTRO = {
  ...
  body: [
    ...
    "The 2026 edition is themed The African Blue-Garnet Awards for Education. The flagship event is the Gold-Blue Garnet Awards Gala on 22 October 2026 in Lagos, Nigeria.",
  ],
} as const;
...
export const CORE_IDENTITY = [
  ...
  { label: "Date", value: "22 October 2026" },
...
export const KEY_PROGRAMMES = [
  {
    ...
    body: "The flagship recognition ceremony of NESA-Africa 2026, bringing together nominees, winners, sponsors, judges, partners, education leaders, government representatives, media organisations, volunteers and stakeholders. 22 October 2026 · Lagos, Nigeria.",
  },
  {
